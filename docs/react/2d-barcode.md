...
export default function BarcodeDemo() {
  return <Barcode type="qr-code">https://apron.design</Barcode>
}
```
:::
...
export default function BarcodeDemo() {
  return <Barcode type="qr-code">为什么你扫描就能看到这行字？</Barcode>
}
```
:::
...
export default function BarcodeDemo() {
  return <Barcode type="maxicode">为什么你扫描就能看到这行字？</Barcode>
}
```
:::
...
export default function BarcodeDemo() {
  return <Barcode type="data-matrix">为什么你扫描就能看到这行字？</Barcode>
}
```
:::
...
export default function BarcodeDemo() {
  return <Barcode type="pdf417">为什么你扫描就能看到这行字？</Barcode>
}
```
:::
...
export default function BarcodeDemo() {
  return <Barcode type="aztec-code">为什么你扫描就能看到这行字？</Barcode>
}
```
:::
