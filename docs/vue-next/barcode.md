...
```vue
<template>
  <ad-barcode :width="400" :height="100">12345678901</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="upc-a" :width="400" :height="100">12345678901</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="upc-e" :width="400" :height="100">01234565</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="ean-13" :width="400" :height="100">123456789012</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="ean-8" :width="400" :height="100">1234567</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="code128" :width="400" :height="100">200111171103</ad-barcode>
</template>
```
:::
...
```vue
<template>
  <ad-barcode type="code39" :width="400" :height="100">ABC23M</ad-barcode>
</template>
```
:::
